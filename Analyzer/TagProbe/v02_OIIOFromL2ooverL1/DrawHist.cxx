...
void DrawHistForEachVariable(TString var)
{
  ...
  TString fileName_90 = "ROOTFile_TnPHist_OIIOFromL2ooverL1_90.root";
  TString fileName_80 = "ROOTFile_TnPHist_OIIOFromL2ooverL1_80.root";
  TString fileName_70 = "ROOTFile_TnPHist_OIIOFromL2ooverL1_70.root";
  TString fileName_60 = "ROOTFile_TnPHist_OIIOFromL2ooverL1_60.root";
  TString fileName_50 = "ROOTFile_TnPHist_OIIOFromL2ooverL1_50.root";
  ...
  if( var == "Pt" )
    canvasRatio->RegisterLatex( 0.16, 0.91, "#font[42]{#scale[0.6]{(OI+IO)FromL2 / L1}}");
  else
    canvasRatio->RegisterLatex( 0.16, 0.91, "#font[42]{#scale[0.6]{(OI+IO)FromL2 / L1 (P_{T} > 29 GeV)}}");
