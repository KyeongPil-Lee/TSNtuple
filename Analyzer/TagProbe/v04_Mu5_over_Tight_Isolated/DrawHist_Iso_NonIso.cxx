...
void DrawHistForEachVariable(TString menu, TString var, Bool_t setZoomIn = kFALSE)
{
  ...
  TString fileName_NonIso = "../v02_Mu5_over_TightNonIso/ROOTFile_TnPHist_menu"+menu+".root";
  ...
  canvasRatio->Register(g_Iso, "Mu5 / L1SingleMu3 + TightID + PFIso(d#beta)/P_{T} < 0.25", kGreen+2);
  canvasRatio->Register(g_NonIso, "Mu5 / L1SingleMu3 + TightID + PFIso(d#beta)/P_{T} > 0.25", kViolet);
