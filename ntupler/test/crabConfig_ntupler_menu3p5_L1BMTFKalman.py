...
if __name__ == '__main__':
    ...
    # config.General.requestName = 'TSNtuple'+version+'SingleMuon_Run2018D_Run322625_DCSOnly_Menuv3p5_KBMTF'
    # config.Data.inputDataset = '/SingleMuon/Run2018D-PromptReco-v2/AOD'
    # config.Data.runRange = '322625-322625'
    # config.JobType.psetName = 'HLTCfgMu_Menu3p5_L1BMTFKalman.py'
    # config.Data.useParent = True
    # crabCommand('submit', config = config)

    # -- for rate: no need to use parent, different run range (run need to be available in HLTPhysics) & JSON
    config.General.requestName = 'TSNtuple'+version+'EphemeralHLTPhysics1_Run2018D_Run321755_Golden_Menuv3p5_KBMTF'
    ...
    # config.General.requestName = 'TSNtuple'+version+'EphemeralHLTPhysics2_Run2018D_Run321755_Golden_Menuv3p5_KBMTF'
    ...
    # config.General.requestName = 'TSNtuple'+version+'EphemeralHLTPhysics3_Run2018D_Run321755_Golden_Menuv3p5_KBMTF'
    ...
    config.General.requestName = 'TSNtuple'+version+'EphemeralHLTPhysics4_Run2018D_Run321755_Golden_Menuv3p5_KBMTF'
    ...
    config.General.requestName = 'TSNtuple'+version+'EphemeralHLTPhysics5_Run2018D_Run321755_Golden_Menuv3p5_KBMTF'
    ...
    config.General.requestName = 'TSNtuple'+version+'EphemeralHLTPhysics6_Run2018D_Run321755_Golden_Menuv3p5_KBMTF'
    ...
    # config.General.requestName = 'TSNtuple'+version+'EphemeralHLTPhysics7_Run2018D_Run321755_Golden_Menuv3p5_KBMTF'
    ...
    # config.General.requestName = 'TSNtuple'+version+'EphemeralHLTPhysics8_Run2018D_Run321755_Golden_Menuv3p5_KBMTF'
